...
groups = []
for group, files in [('App', app_files), ('Tests', test_files)]:
    refs, builds = [], []
    for file in files:
...
products = obj('products', f'{{isa = PBXGroup; name = Products; children = {array([app_product,test_product])}; sourceTree = "<group>";}}')
...
obj('project', f'{{isa = PBXProject; attributes = {{BuildIndependentTargetsInParallel = YES; LastUpgradeCheck = 2700;}}; buildConfigurationList = {uid("Projectconfigs")}; compatibilityVersion = "Xcode 14.0"; developmentRegion = en; knownRegions = (en, Base); mainGroup = {main}; productRefGroup = {products}; projectDirPath = ""; projectRoot = ""; targets = {array([uid("appTarget"),uid("testTarget")])};}}')
