...
for scope in ['Project','App','Tests','UITests']:
    ...
    for config in ['Debug','Release']:
        values = {'SWIFT_VERSION':'5.0', 'IPHONEOS_DEPLOYMENT_TARGET':'17.0', 'SDKROOT':'iphoneos', 'TARGETED_DEVICE_FAMILY':'1,2', 'CLANG_ENABLE_MODULES':'YES', 'ENABLE_USER_SCRIPT_SANDBOXING':'NO'}
