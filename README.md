...
5. Generate a demo PNG and exercise Share, Save to Files, and Print. Open the exported PNG in Files. Check that print preview retains the whole page and margins. Confirm actual output with your AirPrint printer.
